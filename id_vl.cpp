...
#ifdef _HARMATTAN
unsigned screenWidth = N950_W;
unsigned screenHeight = N950_H;
#else
...
#define VB_F "/usr/share/wolf3d+touch/anna_buttons.png"

SDL_Surface *vb_surface = NULL;

SDL_Rect sprite_rects[TotalFunction] = {
	{
		YX,
		YY_R,
		VB_W, VB_W
...
SDL_Rect button_sdlrects[TotalFunction] = {
	{
		N950_W - VB_W - VB_S,
